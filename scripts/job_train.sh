...
#BSUB -o /gpfsdata/home/Zhaobo_hengjia21/GlowIP/results/output_train.txt
#BSUB -e /gpfsdata/home/Zhaobo_hengjia21/GlowIP/results/errput_train.txt
...
python train_glow.py -batchsize 1 -dataset BraTS >> train_log.txt
